...
\end{figure}    
    \hspace{7cm} \wildcard{\centerline{MD Tanzim Reza} \\ \centerline{Lecturer}\\ \centerline{Department}\\ \centerline{Institution} } \hspace{1cm} 
\end{center}
...
\begin{center}
    ...
    \hspace{7cm} \wildcard{\centerline{Md. Golam Rabiul Alam, PhD} \\ \centerline{Associate Professor} \centerline{Department}\\ \centerline{Brac University} } \hspace{1cm} 
\end{center}
